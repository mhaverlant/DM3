...
print "avec dropout  0.2"
dmlp = Drop.MLP([784, 100,  10],  fa='sigmoid', lr = 0.05, n_iter=10, wdecay=.000000, dropout = True , dropout_rate= 0.2)
dmlp.reset()

dmlp.fit(X_train, Y_train)


print dmlp.score(X_train, Y_train)
print dmlp.score(X_test, Y_test)

print "sans dropout"

mlp = Drop.MLP([784, 100,  10],  fa='sigmoid', lr = 0.05, n_iter=10, wdecay=.000000)
mlp.reset()
